...
<div class="container">         
  ...
  <form action="/orderplace" method="POST">
        @csrf
        <textarea type="text" name="address" class="address_textarea" placeholder="Input your address" required></textarea><br><br>
        <p><strong>Payment method</strong></p>
        <input type="radio" name="payment" value="online" required><span>online payment</span><br><br>
        <input type="radio" name="payment" value="EMI" required><span>EMI payment</span><br><br>
        <input type="radio" name="payment" value="cash" required><span>Payment on Delivery</span><br><br>
